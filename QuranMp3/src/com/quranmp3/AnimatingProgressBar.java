...
public class AnimatingProgressBar extends ProgressBar {
		...
		if (animator == null) {
			...
			animator.addUpdateListener(new AnimatorUpdateListener() {
				...
				public void onAnimationUpdate(ValueAnimator animation) {
					AnimatingProgressBar.super.setProgress((Integer) animation
							.getAnimatedValue());
				}
			});
		} else
	...
	public synchronized void setSecondaryProgress(int secondaryProgress) {
		...
		if (animatorSecondary == null) {
			animatorSecondary = ValueAnimator.ofInt(getProgress(),
					secondaryProgress);
			...
			animatorSecondary.addUpdateListener(new AnimatorUpdateListener() {
				...
				@Override
				public void onAnimationUpdate(ValueAnimator animation) {
					AnimatingProgressBar.super
							.setSecondaryProgress((Integer) animation
									.getAnimatedValue());
				}
			});
		} else
