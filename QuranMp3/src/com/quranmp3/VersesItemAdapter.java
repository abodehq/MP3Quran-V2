...
public class VersesItemAdapter extends BaseAdapter implements Filterable {

	private VersesFragment activity;
	...
	public VersesItemAdapter(VersesFragment _scope,
			ArrayList<Verses> recitersList) {
		activity = _scope;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			vi = inflater.inflate(R.layout.ly_verses_item, null);
		...
		if (txt_ayah_count != null) {
			if (verse.getAyahCount() > 9)
				txt_ayah_count.setText(verse.getAyahCount() + "  "
						+ verses_ayah_count_pre);
			else
				txt_ayah_count.setText(verse.getAyahCount() + " "
						+ verses_ayah_count_small);
